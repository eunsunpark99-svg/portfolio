...
const localizedTabs = {
  ...
  hi: {
    images: ['छवियाँ', 'चयनित छवि आर्काइव', 'कृतियों की छवियों और परियोजना अभिलेखों को शांत लेआउट में देखें.'],
    videos: ['वीडियो', 'वीडियो आर्काइव', 'प्रदर्शनी वीडियो, कार्य प्रक्रिया, साक्षात्कार और संबंधित अभिलेख.'],
    about: ['परिचय', 'कलाकार और अभ्यास', 'रेखा, टेप और स्थान के आसपास विकसित Park Eunsun के कार्य का परिचय.'],
  },
  ja: {
